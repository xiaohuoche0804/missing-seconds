#!/usr/bin/env python3
"""Publish chapter 12 to fanqienovel - using existing user browser"""
...
with sync_playwright() as p:
    ...
    try:
        # Try different approaches to find the title input
    ...
    try:
        # Try to find by placeholder containing "章节" or "标题"
